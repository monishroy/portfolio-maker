        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    ...
                    <input type="text" wire:model="inputs.{{$index}}.job_title" class="form-control" id="jobTitle" placeholder="Job title">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input type="text" wire:model="inputs.{{$index}}.company_name" class="form-control" id="companyName" placeholder="Company name">
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" wire:model="inputs.{{$index}}.description" id="jobDescription" rows="3" placeholder="Enter description"></textarea>
            ...
            <div class="col-md-6 mb-4">
                <div class="bg-light p-3 rounded">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" wire:click="delete({{$experience->id}})" data-bs-toggle="modal" data-bs-target="#deleteModel" class="badge bg-danger-subtle text-danger fs-12"><i class="ri-delete-bin-6-line align-bottom me-1"></i>Delete</a>
                        </div>
                    </div>
