                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                ...
                                <a href="{{ url('') }}" class="logo logo-light">
                                    <img src="{{ url('backend/assets/images/logo-light.png') }}" alt="" height="17">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Premium backend & Dashboard Template</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4 card-bg-fill">
                            <div class="card-body p-4 text-center">
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="text-muted">Thank you for using <span class="fw-semibold">velzon</span> backend template</p>
                                    <div class="mt-4">
