...
<div class="row">
    <div class="col-lg-12">
        <form action="{{ route('templates.update', $template->id) }}" autocomplete="off" class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="temp_name" class="form-control @error('temp_name') border-danger @enderror" id="product-title-input" placeholder="Enter product title" value="{{ $template->name }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="temp_path" class="form-control @error('temp_path') border-danger @enderror" id="product-title-input" placeholder="Enter product title" value="{{ $template->path }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="content" name="description" required>{{$template->description}}</textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <div class="w-100">
                                    <input class="form-control d-none" name="images[]" type="file" id="image-input" multiple="multiple">
                                        ...
                                        <div class="d-flex row">
                                            <div class="col-6">
                                                <div class="bg-light rounded">
                                                    <img class="img-fluid rounded d-block" src="{{ asset('storage/templates/'.$template_image->name) }}" alt="Product-Image" />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="pt-1">
                                                    <h5 class="fs-14 mb-1">{{ $template_image->name }}</h5>
                                                    <p class="fs-13 text-muted mb-3">{{ date('d M, Y', strtotime($template_image->created_at)) }}</p>
                                                    <a href="{{ route('template.image.delete', $template_image->id) }}" class="btn btn-sm btn-danger">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
