...
<!doctype html>
<html lang="en" data-layout="horizontal" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-bs-theme="light" data-body-image="img-1" data-preloader="disable" data-layout-width="boxed">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ url('') }}" class="logo logo-dark">
                    <span class="logo-sm"><img src="{{ url('backend/assets/images/logo-sm.png') }}" alt="" height="22"></span>
                    <span class="logo-lg"><img src="{{ url('backend/assets/images/logo-dark.png') }}" alt="" height="25"></span>
                </a>
                <!-- Light Logo-->
                <a href="{{ url('') }}" class="logo logo-light">
                    <span class="logo-sm"><img src="{{ url('backend/assets/images/logo-sm.png') }}" alt="" height="22"></span>
                    <span class="logo-lg"><img src="{{ url('backend/assets/images/logo-light.png') }}" alt="" height="25"></span>
                </a>
