                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1"><span id="getup"></span>, {{ Auth::user()->fname }}!</h4>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ url('backend/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ url('backend/assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ url('backend/assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ url('backend/assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ url('backend/assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
...
@push('js')
    ...
    <!-- Vector map-->
    <script src="{{ url('backend/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
    <script src="{{ url('backend/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>
    <!--Swiper slider js-->
    <script src="{{ url('backend/assets/libs/swiper/swiper-bundle.min.js') }}"></script>
    <!-- Dashboard init -->
    <script src="{{ url('backend/assets/js/pages/dashboard-ecommerce.init.js') }}"></script>
    <script>
